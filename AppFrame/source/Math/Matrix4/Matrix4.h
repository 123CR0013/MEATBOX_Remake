...
public:
	...
	void SetColum(unsigned char num ,const Vector3& vector) {
		mat[0][num] = vector.x;
		mat[1][num] = vector.y;
		mat[2][num] = vector.z;
	}

	void SetLine(unsigned char num, const Vector3& vector) {
		mat[num][0] = vector.x;
		mat[num][1] = vector.y;
		mat[num][2] = vector.z;
	}
	...
	{
		return Vector3(mat[0][0], mat[0][1], mat[0][2]).Normalize();
	}

	// Get the Y axis of the matrix (left)
	Vector3 GetYAxis() const
	{
		return Vector3(mat[1][0], mat[1][1], mat[1][2]).Normalize();
	}

	// Get the Z axis of the matrix (up)
	Vector3 GetZAxis() const
	{
		return Vector3(mat[2][0], mat[2][1], mat[2][2]).Normalize();
	}
