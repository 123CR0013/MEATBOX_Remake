...
bool XInput::Input() {
	...
	_adjustedLStick.x = MyMath::Clamp(-1.0f, 1.0f, _adjustedLStick.x);
	_adjustedLStick.y = MyMath::Clamp(-1.0f, 1.0f, _adjustedLStick.y);
	_adjustedRStick.x = MyMath::Clamp(-1.0f, 1.0f, _adjustedRStick.x);
	_adjustedRStick.y = MyMath::Clamp(-1.0f, 1.0f, _adjustedRStick.y);
